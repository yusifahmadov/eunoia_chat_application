...
class DhKeyPair extends Equatable {
  ...
  factory DhKeyPair.fromJson(Map<String, dynamic> json) {
    return DhKeyPair(
      privateKey: DhPrivateKey.fromJson(json['privateKey'] as Map<String, dynamic>),
      publicKey: DhPublicKey.fromJson(json['publicKey'] as Map<String, dynamic>),
      userId: json['userId'],
    );
  }
}
